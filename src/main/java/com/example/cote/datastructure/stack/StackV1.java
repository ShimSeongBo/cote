...
public class StackV1 {
    ...
    // 분명히 상웅이는 why? ArrayList 사용했는지 물어보겠지? 일단 내가 아는건 Array/LinkedList 인데, 선형 비선형? ArrayList는 연결되어있고 서칭속도 빠름 -> 메모리에 저장되는 . , LinkedList는 그럴수도 아닐수도 두가지 방향일수도 수정/삭제 용이함.
    ...
    public int peek() {
        ...
        return stackSavingSystem.get(stackSavingSystem.size() - 1);
    }
}
