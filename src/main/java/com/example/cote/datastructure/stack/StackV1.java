...
public class StackV1 {
    ...
    List stackSavingSystem = new ArrayList(); // List 변수명에 list , List 이런식으로 들어가면 좋지 않다고 본 기억이..ㅎ 근데 뭐라고 지어야 잘 지었다고 소문이날까 ㅎ ESG 생각나서 만들어버림..!
    ...
    public int pop() {
        ...
        return (int) stackSavingSystem.remove(stackSavingSystem.size() - 1);
    }
    ...
    public int peek() {
        ...
        return (int) stackSavingSystem.get(stackSavingSystem.size());
    }
}
